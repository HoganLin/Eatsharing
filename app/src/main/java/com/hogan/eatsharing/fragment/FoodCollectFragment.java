...
public class FoodCollectFragment extends Fragment {
    ...
    public FoodCollectFragment(){

    }

    public  static FoodCollectFragment newInstance(){
        FoodCollectFragment fragment = new FoodCollectFragment();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        layoutView = inflater.inflate(R.layout.fragment_collect_food,container,false);

        reqManager = ReqManager.getInstance();
        foods = new ArrayList<>();

        recyclerView = layoutView.findViewById(R.id.list_food);
    ...
    private void initData(String uid) {
        reqManager.getCollectFood(uid,(success, foodList) -> {
            Message msg;
            if(success){
