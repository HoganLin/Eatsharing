...
public class RecipeCollectAdapter extends RecyclerView.Adapter<RecipeCollectAdapter.ViewHolder> {
    ...
    public RecipeCollectAdapter(Context context,List<Recipe> recipes){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_collect_recipe,parent,false);
